...
const UserTable = ({ repoData }) => {
  ...
  const handleSort = (clickedColumn) => {
    ...
    setInitialObject({
      ...
      direction:
        initialObject.direction === "ascending" ? "descending" : "ascending",
    });
  };
      ...
      <Table sortable celled fixed>
        <Table.Header>
          <Table.Row>
            <Table.HeaderCell
              sorted={
                initialObject.column === "name" ? initialObject.direction : null
              }
            ...
            <Table.HeaderCell
              sorted={
                initialObject.column === "description"
                  ? initialObject.direction
                  : null
              }
            ...
            <Table.HeaderCell
              sorted={
                initialObject.column === "created_at"
                  ? initialObject.direction
                  : null
              }
          ...
          {initialObject.data.map((repos) => {
            return (
              <Table.Row>
                ...
                <Table.Cell>
                  {" "}
                  <Moment fromNow>{repos.created_at}</Moment>
                </Table.Cell>
              </Table.Row>
            );
          })}
